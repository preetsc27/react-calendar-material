...
var Calendar = function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderDay() {
      ...
      var baseClasses = "calender-day calender-noselect2";
      var today = "";
      var todayStyle = {};
      var containerStyle = {};
      if (opts.today) {
        today = "calender-current";
        todayStyle = {
      ...
      return _react2.default.createElement('div', { className: baseClasses,
        style: containerStyle }, _react2.default.createElement('div', { className: today, style: todayStyle }), _react2.default.createElement('div', { className: selected, style: selectedStyle }), _react2.default.createElement('h5', { className: 'calender-h5',
    ...
    value: function renderHeaders() {
      ...
      for (var i = 0; i < config.week_subs.length; i++) {
        header.push(_react2.default.createElement('p', { className: 'calender-day-headers calender-noselect' }, config.week_subs[i]));
      }
    ...
    value: function render() {
      ...
      if (this.props.showHeader) {
        upperDate = _react2.default.createElement('div', { className: 'flex-2 calender-header center', style: {
            backgroundColor: this.props.accentColor
          } }, _react2.default.createElement('p', { className: 'calender-header-month' }, tMonth.toUpperCase()), _react2.default.createElement('p', { className: 'calender-header-day' }, tDate));
      }
      return _react2.default.createElement('div', { className: this.props.orientation }, upperDate, _react2.default.createElement('div', { className: 'calender-padding' }, _react2.default.createElement('div', { className: 'calender-month' }, _react2.default.createElement('img', { className: 'calender-month-arrow-left', src: _ic_back2.default, alt: 'back', onClick: this.prev.bind(this) }), _react2.default.createElement('p', { className: 'calender-month-title' }, month, _react2.default.createElement('br', null), _react2.default.createElement('span', { className: 'calender-month-year' }, year)), _react2.default.createElement('img', { className: 'calender-month-arrow-right', src: _ic_forward2.default, alt: 'forward', onClick: this.next.bind(this) })), _react2.default.createElement('div', { className: 'calender-footer' }, header, days)));
    }
  }]);
